package com.opendatasoft.lucene.analysis.synonym;
...
import com.opendatasoft.elasticsearch.index.analysis.SynonymMapReloader;
...
public final class SynonymReloaderFilter extends TokenFilter {
     ...
     * @param synonymMapReloader synonym map reloader
     ...
     */
    public SynonymReloaderFilter(TokenStream input, SynonymMapReloader synonymMapReloader, boolean ignoreCase) {
        super(input);

        this.synonymMapReloader = synonymMapReloader;
        this.synonyms = synonymMapReloader.getSynonymMap();
    ...
    */
    ...
    public void reset() throws IOException {
        super.reset();
        if (synonymMapReloader.isModified()) {
            synonyms = synonymMapReloader.getSynonymMap();
            this.fst = synonyms.fst;
            if (fst == null) {
                throw new IllegalArgumentException("fst must be non-null");
            }
